...
public class UnityGameobjectThumbnail :MonoBehaviour{
    ...
    public static bool makeThumbnailPng_from_Gameobject(GameObject unit, string savePath, int width, int height)
    {
